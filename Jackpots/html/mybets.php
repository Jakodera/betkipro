...
<table>
  <caption>No bets Currently</caption>
  <thead>
    <tr>
  ...
  $sql=mysqli_query($conn,"SELECT * from bets_table where user__id='$id' ORDER BY time_placed DESC");
  ...
  if(mysqli_num_rows($sql)>0){
    ...
    <tr>
      ...
      <td data-label="Bet id"><a style="color:green;" href="betresult.php?bet='.$bet_id.'">'.$bet_id.'</a></td>
      <td data-label="Status">'.$bet_status.'</td>
      <td data-label="Possible Win">ksh'.$possiblewin.'</td>
      <td data-label="Date Placed">'.$time_placed.'</td>
