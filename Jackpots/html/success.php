  ...
  echo'
    <div class="row">
      ...
      <div class="modalbox success col-sm-8 col-md-6 col-lg-5 center animate">
        ...
        <h1>Success!</h1>
        <p>Jackpot Bet has been placed successfully
          <br>Good luck!</p>
    ...
    <div class="row">
      <div class="modalbox error col-sm-8 col-md-6 col-lg-5 center animate">
        ...
        <h1>Oh no!</h1>
        <p>Oops! Input bet amount of 49,
          <br> or Kindly top up your account.</p>
      ...
      <div class="row">
        <div class="modalbox error col-sm-8 col-md-6 col-lg-5 center animate">
          ...
          <a href="../index.php"><button type="button" class="redo btn">Try </button></a>
          <span class="change">-- Click to advance to home. --</span>
        </div>
      </div>';
    }else if($error=="zero"){
      ...
      <div class="row">
        <div class="modalbox error col-sm-8 col-md-6 col-lg-5 center animate">
          ...
          <h1>Oh no!</h1>
          <p>Sorry ! You can\'t bet with amount not equal to 49,
            <br> you should kindly try again.</p>
