...
<article class="withdraw-confirm-popup">
  <div class="withdraw-confirm-popup__header">
      ...
      <button style="background:orange; color:white; padding:20px 20px 20px 20px; border-radius:10px; border:none;" onclick="history.back()">Home</button>
      
    <h1 >
    CONFIRM WITHDRAWAL TO <br> 
