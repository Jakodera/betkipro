...
if (isset($_SESSION['usernumber'])) {
    ...
    if (!empty($word) && $word == 49 && is_int((int)$word)) {
        ...
        if ($account < $word) {
            ...
            $stmt = $conn->prepare($sql);
            $stmt->execute();
            header('location:../Jackpots/html/success.php?message=balance');
        } else {
            ...
            mysqli_query($conn,"INSERT INTO bets_table(bet_id,user__id,bet_status,bet_amount,possiblewin,total_odds) VALUES ('$bet_id','$username','not placed','$word','20000','$total_odds') " );
