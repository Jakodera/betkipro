...
while($p<40){
    curl_setopt_array($curl, [
        ...
        CURLOPT_HTTPHEADER => [
            ...
            "X-RapidAPI-Key: d7309da350msh4db2d49cab9421cp1dc27fjsn0baba4527c7d"//your api key here
        ],
    ]);
...
if ($err) {
    ...
    $sql=mysqli_query($conn, "INSERT INTO odds_table(fixture_id,home_win,away_win,draw,onex,one2,X2,gg,ngg,dnb1,dnb2,ov25,ov35,ov15,ov05,un05,un15,un25,un35,half1,halfX,half2,half1n1,half1n2,half1nx,half2n1,half2n2,half2nx,halfxn1,halfxn2,halfxnx,win2nillhome_yes,win2nillhome_no,win2nillaway_yes,win2nillaway_no) VALUES
    ('$league','$home','$away','$draw','$onex','$twox','$X2','$gg','$ngg','$dnb1','$dnb2','$ov25','$ov35','$ov15','$ov05','$un05','$un15','$un25','$un35','$half1','$halfX','$half2','$half1n1','$half1n2','$half1nx','$half2n1','$half2n2','$half2nx','$halfxn1','$halfxn2','$halfxnx','$win2nillhome_yes','$win2nillhome_no','$win2nillaway_yes','$win2nillaway_no')" );

    echo" APIS WORK SUCCESSFULLY <br/>";
    //echo $conn->error;
