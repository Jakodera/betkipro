...
<body>
    ...
    <navo>
        <ul>
            ...
            <li><a href="Jackpots/index.php" style="font-weight: 900;"><sup><i class="fa fa-trophy" style="color: gold; font-size: 12px;" aria-hidden="true"></i></sup>Jackpots</a></li>
            ...
            <li><a href="Aviator/index.html" style="font-weight: 900;"><sup><i class="fa fa-play" style="color: green; font-size: 12px;" aria-hidden="true"></i></sup>Casino</a></li>
    ...
    ORDER BY `commence_time` ASC";
        ...
        while ($row = $stmt->fetch()) {
            ...
            // if($commence_time>time()){
                // time taken to post matches

            if ((empty($search_term) || stripos($home_team, $search_term) !== false || stripos($away_team, $search_term) !== false) && $commence_time < time()) {
                echo '
