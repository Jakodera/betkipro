...
?>
<div class=" mobile top-nav d-flex flex-row p-md-2 justify-content-between align-items-center bg-dark">
  ...
  <div class="p-2 d-flex align-items-center top-right-nav">
    ...
    <div class="input-group main-search">
      <input id="searchbar" onkeyup="search_animal()" type="text" name="search" placeholder="Search here..." aria-describedby="button-addon5" class="form-control" />
    ...
    <div class="mobsearchbar d-md-none ">
      ...
      <div class="togglesearch">
        <input id="searchbarMob" onkeyup="search_mobo()" type="text" name="search" placeholder="Search here..." />
    ...
    <?php if (!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true) : ?>
      ...
      <div class="top-btn">
        <a class="btn-login btn btn-outline-primary" href="login.php">Login</a>
        <a class="btn-register btn btn-primary" href="register.php">Register</a>
      </div>
    <?php else : ?>
        ...
        <div class="user__log-in">
          <div class="balance">
            <div class="balance__info">
              <div class="balance__info-money">
                ...
                <span class="balance__info-money-currency">KES</span>
              </div>
                ...
                <ul class="account__dropdown-list">
                  <li class="account__dropdown-item">
                    ...
                    <div class="account__dropdown-right">
                      <span class="account__dropdown-right-number account__dropdown-right-number--green"><?php echo $balance; ?></span> KES
                    </div>
                  </li>
                  <li class="account__dropdown-item">
                  ...
                  <li class="account__dropdown-item-center "> 1 POINT = 1 KES </li>
                </ul>
          ...
          <div class="account-menu">
            ...
            <ul class="account-menu__list">
              ...
              <li class="account-menu__item">
                <a class="account-menu__link" tabindex="-1" href="withdrawal.php">withdraw </a>
              </li>
      ...
      <div class="mobile">
        <div class="mb-main-header__right">
              ...
              <div class="mb-account-info">
                <div class="mb-container" role="button">
                  <div class="mb-account-info__deposit">
                    ...
                    <span class="mb-account-info__deposit-currency">KES</span>
                  </div>
                  <div class="mb-account-info__id">
                    <span class="mb-account-info__id-key">ID:</span>
                    <span class="mb-account-info__id-value"><?php echo $u_id; ?></span>
                  </div>
                </div>
          ...
          <div class="profile_nav navbar-collapse" id="profile_nav">
            ...
            <ul class="navbar-nav w-100 justify-content-center align-items-stretch px-3">
              <li class="nav-item">
